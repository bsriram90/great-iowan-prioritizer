 ...
 */
public class BuildTestCaseDifferenceMatrix {
    private static String TRACE_FILES_DIRECTORY = null;
    private List<String> files = null;

    public BuildTestCaseDifferenceMatrix(String path) throws Exception {
        ...
        for (int i = 0; i < allDirectories.length; i++) {
            ...
            String[] files = Util.getAllFiles(dir);
            ...
            for (int j = i + 1; j < allDirectories.length; j++) {
                for (int k = 0; k < files.length; k++) {
                    ...
                    String[] filesToCompare = Util.getAllFiles(dir);
    ...
    public static void main(String[] args) throws Exception {
        BuildTestCaseDifferenceMatrix matrix = new BuildTestCaseDifferenceMatrix("res/xml-security/");
    }
}
