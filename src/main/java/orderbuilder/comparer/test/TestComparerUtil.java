...
public class TestComparerUtil {
    ...
    public static Object[] getOrderUntilDifferingTest(Logger logger, ChangeMatrix<Long> changeMatrix, String startTest, Long threshold, boolean debug) throws Exception {
